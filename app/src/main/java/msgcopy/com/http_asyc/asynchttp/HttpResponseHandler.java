package msgcopy.com.http_asyc.asynchttp;
...
import msgcopy.com.http_asyc.LogUtil;
...
public class HttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    public void onFailure(int statusCode, org.apache.http.Header[] headers, byte[] responseBody, Throwable error) {
        ...
        String message = MsgApplication.getInstance().getString(R.string.str_network_not_good);
